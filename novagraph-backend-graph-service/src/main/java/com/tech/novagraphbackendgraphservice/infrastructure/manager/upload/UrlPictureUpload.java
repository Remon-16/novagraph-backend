package com.tech.novagraphbackendgraphservice.infrastructure.manager.upload;
        ...
        try {
            ...
            if (StrUtil.isNotBlank(contentLengthStr)) {
                try {
                    ...
                    ThrowUtils.throwIf(contentLength > fileSize * ONE_M, ErrorCode.PARAMS_ERROR, "文件大小不能超过 5MB");
